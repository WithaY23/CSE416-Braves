...
| GUI-2 | `/api/states/{stateId}/districts/enacted/topology` | OR | `stateId=OR` | file-backed TopoJSON | `src/data/oregon_congressional_districts.topojson` | `Live` |
| GUI-2 | `/api/states/{stateId}/districts/enacted/topology` | SC | `stateId=SC` | file-backed TopoJSON | `src/data/south_carolina_congressional_districts.topojson` | `Live` |
...
| GUI-9 | `/api/states/{stateId}/analysis/gingles?group=...&election=...` | SC | `stateId=SC&group=black&election=2024_pres` | `gingles_results` | `mock-data/v1/gingles-scatter/SC_2024_black.json` | `Live` |
| GUI-10 | `/api/states/{stateId}/analysis/gingles/table?group=...&election=...` | OR | `stateId=OR&group=latino&election=2024_pres` | `gingles_tables` | `mock-data/v1/gingles-table/OR_2024_latino.json` | `Live` |
| GUI-10 | `/api/states/{stateId}/analysis/gingles/table?group=...&election=...` | SC | `stateId=SC&group=black&election=2024_pres` | `gingles_tables` | `mock-data/v1/gingles-table/SC_2024_black.json` | `Live` |
...
| GUI-19 | `/api/states/{stateId}/districts/interesting?planId=...` | OR, SC | `stateId + planId` | `interesting_plans` | seeded by `SeedDataLoader.seedInterestingPlans()` using stored district TopoJSON | `Live` |
